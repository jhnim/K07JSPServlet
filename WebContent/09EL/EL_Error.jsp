...
<body>
	<fieldset>
		...
		<!--  
			...
			컬렉션의 크기만큼 반복하는 확장 for문 형태로 기술되었다.
		-->
		...
		<!--  
			인덱스를 초과하면 예외가 발생되어야 하지만 EL에서는 기본적인
			예외를 잡아주므로 에러가 발생되지는 않는다.
		-->
		<h2>인덱스를 벗어난 경우</h2>
		<ul>
			<li>\${elArray[3] } 
		...
		<ul>
			<li>존재하지 않는 속성 : \${eldto.addr }
				:
				\${eldto.addr }[propertyBotFoundException발생]
				</li>
		...
		<h2>EL의 내장 객체중 사용자가 정의한 속성에 접근하는 내장객체 및
			맵 컬렉션인 경우</h2>
		<%
