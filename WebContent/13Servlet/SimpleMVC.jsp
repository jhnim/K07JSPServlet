...
<body>
	<h2>간단한 MVC패턴 만들기</h2>
	<!--  
		사용자가 요청할때 type 파라미터에 따라 서블릿은 각기 다른 처리를 하게된다.
	-->
	<ul>
		<li>
			<a href="./SimpleMVC">
		...
		<li>
			<a href="SimpleMVC?type=greeting&id=ko1&pw=1234">
	...
	<!--  
		요청명을 결정할때는 View의 경로와 동일한 depth(깊이)로 설정하는 것이 좋다.
		이미지의 경로, CSS, JS파일을 상대경로로 링크했을때 경로가 깨지는 경우가
		발생할 수 있기 때문이다.
		아래 이미지의 경우 요청명이 
