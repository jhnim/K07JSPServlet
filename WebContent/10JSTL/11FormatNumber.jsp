...
<!-- JSTL의 국제화라이브러리를 사용하기 위한 지시어 선언 -->
...
<body>
	...
	<!-- groupingUsed의 디폴트값이 true이므로 콤마출력됨 -->
	...
	money : <fmt:formatNumber value="${money }" type="percent" />
	...
	/*  
		NumberFormat클래스는 싱글패턴으로 제작된 클래스로 new연산자를 통해
		객체를 생성할 수 없는 대표적인 클래스이다.
		getInstance()를 통해 이미 생성된 static형태의 객체를 반환받아 사용하게 된다
	*/
