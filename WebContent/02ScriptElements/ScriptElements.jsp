<%--  
	...
	지시자(Directive) :페이지 속성을 지정하거나 외부문서를 포함(include)할때 사용한다.
...
<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8"%>
<%-- 
	선언부(Declaration) : 스크립트렛이나 표현식에서 사용할 메소드를 선언할때 사용한다.
...
<body>
	...
	스크립트릿(Scriptlet) : 주로 JSP코드를 작성하고 실행할때 사용하는 영역이다.
		스크립트릿은 head영역, body영역 어디서든 사용할 수 있다. 또한 <script>, <style>태그 내부에서도 사용할 수 있다.
	--%>
	<%
	int value1 = 3;
	int value2 = 0;
	...
	표현식(Expression) : 변수를 웹브라우저상에 출력할때 사용한다.
		JS의 document.write()와 동일한 역할을 한다. 표현식 사용시 주의할점은 문장끝에 ;(세미콜론)을 생략해야 하는 것이다.
	--%>
