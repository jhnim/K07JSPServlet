...
<body>
<%-- 
웹어플리케이션능 구성하는 모든 JSP(Servlet)에서 String형의 상수를 공유할 목적으로
사용한다. web.xml에 <context-param>엘리먼트를 통해 등록하게 된다.
...
<%-- 
ServletContext의 메소드인 getRealPath()로 서버의 물리적경로를 얻어올 수 있다.
...
<ul>
	...
	<li>this내장객체(주로선언부에서 사용) :
		<%=this.getServletContext().getRealPath("/images") %></li>
</ul>

<%-- 
선언부(자바영역)에서 JSP의 내장객체를 사용할때는 해당 내장객체의 클래스타입으로 
사용해야한다. application객체는 ServletContext타입을 가지고 있다.
--%>
