...
<%
	/*
	getHeaderNames() : 클라이언트의 요청헤더의 name속성을
		모두 얻어오는 함수로 반환타입은 Enumeration형이다. 
	*/
	Enumeration headers = request.getHeaderNames();
	/*
	요청헤더값은 사용하는 웹 브라우져의 종류에 따라 다를 수 있다.
	최근에는 웹 표준 (크로스 브라우징)을 위해 각 회사에서 사용하는
