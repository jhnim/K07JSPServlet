...
<body>
	...
	<%
	/*  
	getHeaderNames() : 클라이언트의 요청헤더의 name속성을 모두 얻어오는 함수로 반환타입은 Enumeration형이다.
	*/
	Enumeration headers = request.getHeaderNames();
	/*  
	요청헤더값은 사용하는 웹브라우저의 종류에 따하 다를 수 있다.
	최근에는 웹표준(크로스 브라우징)을 위해 각 회사에서 사용하는 엔진을 동시에 탑재하는 추세로 흘러가고 있다.
	*/
